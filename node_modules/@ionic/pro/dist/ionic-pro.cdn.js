...
var Deploy = /** @class */ (function () {
    ...
    Deploy.prototype.info = function () {
        var _this = this;
        if (this.deployInfo) {
            return Promise.resolve(this.deployInfo);
        }
        return this.app.getPlugin().then(function (plugin) {
            plugin.deploy.info(_this.app.getAppId(), function (info) {
                _this.deployInfo = info;
                return Promise.resolve(info);
            }, function (err) {
                return Promise.reject(err);
            });
        }, function () {
            // TODO: What should we do in web contexts?
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.manifest.load()];
                    case 1:
                        _a.sent();
                        // Initialize services
